            ...
            <section className="bg-gradient-to-r from-black to-indigo-950" id="contact">
                ...
                <div className="flex items-stretch justify-center">
                    ...
                    <div className="h-full pr-6">
                        ...
                        Si te gusto lo que viste, contactanos y trabajemos juntos.
                        </p>
                        <ul className="mb-6 md:mb-0">
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-yellow text-gray-50">
                            ...
                            <p className="text-white dark:text-slate-400">Quito, Quitumbe, Distrito Metropolitano</p>
                        ...
                        <li className="flex">
                            ...
                            <p className="text-white dark:text-slate-400">Gmail: devrise@gmail.com</p>
                            </div>
                        </li>
                        <li className="flex">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-yellow text-gray-50">
